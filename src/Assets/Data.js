...
export default PaginatedComponent;
  ...
  {
    id: "47",
    title: "Encryption and Decryption Utility",
    description:
      "EncryptDecrypt is a utility for generating encryption keys, encrypting strings, and decrypting encrypted data in JavaScript.",
    mainDescription:
      "EncryptDecrypt is a JavaScript utility that provides functions to generate a secure key, encrypt strings, and decrypt data using the Web Crypto API. It uses AES-GCM encryption and requires a key and an initialization vector (IV) for encryption and decryption.",
    input: [
      {
        name: "generateKey",
        type: "function",
        description: "Generates a secure AES-GCM encryption key using the Web Crypto API."
      },
      {
        name: "data",
        type: "string",
      ...
      },
      {
        ...
        type: "CryptoKey",
        description:
          "The encryption key generated by the generateKey function, required for both encryption and decryption."
      },
      {
        name: "iv",
        type: "Uint8Array",
        description:
          "A randomly generated initialization vector for encryption. The same IV must be used for decryption."
      }
    ],
    output: [
      {
        ...
        type: "CryptoKey",
        description:
          "A securely generated key, created by the generateKey function, to be used for encryption and decryption."
      },
      {
        name: "encryptedData",
        type: "ArrayBuffer",
        description:
          "The encrypted data, returned as an ArrayBuffer after encryption."
      },
      {
        name: "decryptedData",
        type: "string",
        description:
          "The decrypted plain text string after decryption, obtained by using the encrypted data, key, and IV."
      }
    ],
    demoCode: `import React, { useState } from 'react';
